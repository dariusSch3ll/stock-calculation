 ...
 */
final class Version20230626121822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stock_calculation (id INT NOT NULL, shop VARCHAR(255) NOT NULL, sku VARCHAR(255) NOT NULL, minimum_stock INT DEFAULT 0 NOT NULL, maximum_stock INT DEFAULT 0 NOT NULL, PRIMARY KEY(id))');
